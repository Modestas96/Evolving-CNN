...
def startGeneratePoolLayer(input_length, max_pool_kernel_size):
    ...
    if type == 0:
        ...
        LAYER = ["MPool"]
    kSize = random.randint(2, int(min(input_length, max_pool_kernel_size)))
    LAYER.append(kSize)
    return LAYER
...
def main():
    ...
    '''
    NETWORKS = [[['Conv', 1, 49], ['Conv', 6, 16], ['FC', 716, 1]],
                [['Conv', 4, 23], ['FC', 502, 1], ['FC', 805, 1]],
                [['Conv', 6, 59], ['Conv', 6, 46], ['FC', 485, 1], ['FC', 345, 1]],
                [['Conv', 13, 30], ['FC', 299, 1], ['FC', 629, 1]],
                [['Conv', 8, 43], ['APool', 2], ['FC', 673, 1]],
                [['Conv', 4, 56], ['APool', 3], ['FC', 193, 1], ['FC', 292, 1]],
                [['Conv', 13, 9], ['MPool', 2], ['MPool', 3], ['Conv', 2, 23], ['FC', 118, 1], ['FC', 809, 1]],
                [['Conv', 7, 62], ['FC', 168, 1], ['FC', 429, 1]],
                [['Conv', 8, 34], ['FC', 861, 1], ['FC', 227, 1]],
                [['Conv', 11, 28], ['MPool', 1], ['Conv', 2, 42], ['MPool', 2], ['MPool', 2], ['APool', 1], ['FC', 796, 1]],
                [['Conv', 9, 10], ['Conv', 4, 49], ['Conv', 11, 7], ['APool', 2], ['FC', 35, 1]],
                [['Conv', 13, 26], ['APool', 3], ['MPool', 3], ['FC', 762, 1], ['FC', 911, 1]],
                [['Conv', 7, 8], ['MPool', 2], ['Conv', 5, 26], ['APool', 1], ['MPool', 3], ['FC', 896, 1]],
                [['Conv', 4, 54], ['MPool', 2], ['FC', 441, 1], ['FC', 321, 1]],
                [['Conv', 10, 46], ['FC', 639, 1]],
                [['Conv', 9, 2], ['Conv', 5, 13], ['FC', 682, 1]],
                [['Conv', 11, 42], ['APool', 2], ['FC', 134, 1], ['FC', 995, 1]],
                [['Conv', 13, 26], ['FC', 890, 1]],
                [['Conv', 9, 64], ['MPool', 3], ['APool', 1], ['FC', 300, 1]],
                [['Conv', 8, 18], ['FC', 173, 1]],
                [['Conv', 10, 48], ['Conv', 7, 53], ['FC', 507, 1], ['FC', 120, 1]],
                [['Conv', 4, 29], ['APool', 1], ['Conv', 12, 33], ['Conv', 7, 24], ['FC', 946, 1]],
                [['Conv', 8, 19], ['Conv', 11, 16], ['MPool', 2], ['FC', 202, 1], ['FC', 542, 1]],
                [['Conv', 11, 9], ['FC', 365, 1]],
                [['Conv', 1, 26], ['MPool', 3], ['FC', 722, 1]],
                [['Conv', 9, 34], ['Conv', 6, 6], ['FC', 161, 1]],
                [['Conv', 10, 63], ['Conv', 2, 9], ['Conv', 13, 10], ['FC', 784, 1]],
                [['Conv', 3, 15], ['FC', 526, 1]],
                [['Conv', 12, 9], ['Conv', 4, 38], ['FC', 326, 1]],
                [['Conv', 6, 36], ['Conv', 8, 2], ['FC', 613, 1]]]
    '''
